...
if ($weather['temp_units']=='C' && $weather["cloudbase3"]>=609){echo "<div class=cloudconvertercircle2000>Clouds<tyellow> ".round($weather["cloudbase3"])."</tyellow><smalltempunit2> m</tblue><smalltempunit2>" ;} else if ($weather['temp_units']=='C' && $weather["cloudbase3"]<609){echo "<div class=cloudconvertercircle>Clouds<tblue> ".round($weather["cloudbase3"])."</tblue><smalltempunit2> m</tblue><smalltempunit2>" ;} else if ($weather['temp_units']=='F' && $weather["cloudbase3"]*3.28084>=1999){echo "<div class=cloudconvertercircle2000>Clouds<tyellow> ".round($weather["cloudbase3"]*3.28084,0)."</tyellow><smalltempunit2> ft<smalltempunit2>" ;} else if ($weather['temp_units']=='F' && $weather["cloudbase3"]*3.28084<1999){echo "<div class=cloudconvertercircle>Clouds<tblue> ".round($weather["cloudbase3"]*3.28084,0)."</tblue><smalltempunit2> ft</tblue><smalltempunit2>" ;}?>
</div></div>
